/**
 * Fusiona Planner sobre Maestro:
 * - Si una tarea existe en ambos (mismo id o mismo nombre), se actualiza con los datos del Planner.
 * - Si una tarea esta solo en Planner, se anade.
 * - Si una tarea esta solo en Maestro, se conserva.
 * Devuelve filas listas para exportar (planas).
 */
