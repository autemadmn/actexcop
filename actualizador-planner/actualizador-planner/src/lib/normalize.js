/**
 * Normaliza columnas heterogeneas (Planner export ES/EN + maestro)
 * a un modelo comun y estable para toda la app.
 */
...
/**
 * Detecta el proyecto dominante (moda) en una hoja.
 */
